...
def get_args():
    ...
    p.add_argument("--w_perceptual", type=float, default=0.1,
                   help="Perceptual loss weight in VAE training (0 = disabled)")
    p.add_argument("--unfreeze_vae", action="store_true",
                   help="Also update VAE weights during temporal/joint phase")
    p.add_argument("--use_uncertainty_weights", action="store_true",
                   help="Learn per-loss uncertainty weights automatically (Kendall et al. 2018)")
